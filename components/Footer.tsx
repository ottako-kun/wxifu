...
const socialLinks = [
  {
    name: 'Twitter / X',
    href: '#', // Replace with actual Ottako-kun Twitter
    icon: (props: React.SVGProps<SVGSVGElement>) => <TwitterIcon {...props} />,
  },
  {
    name: 'Pixiv',
    href: '#', // Replace with Pixiv
    icon: (props: React.SVGProps<SVGSVGElement>) => (
       <svg viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 14.5c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z"/></svg>
    ),
  },
  {
    name: 'Discord',
