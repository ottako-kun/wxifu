        ...
        <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4 text-center">
            <div className="bg-gray-900 border border-red-900/50 rounded-2xl p-8 max-w-md w-full shadow-[0_0_50px_rgba(220,38,38,0.2)] animate-fade-in">
                ...
                <button 
                    ...
                    className="w-full py-3 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl shadow-lg shadow-red-900/20 transition-all uppercase tracking-wider text-sm flex items-center justify-center gap-2 group transform active:scale-95"
                >
