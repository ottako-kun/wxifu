  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 animate-fade-in">
        ...
        >
          OTAKU<span className="text-white">-</span>X
        </h1>
        ...
        <p className="text-lg md:text-2xl font-medium text-gray-200 tracking-wide mb-8 max-w-2xl mx-auto">
          Are you a <span className="text-pink-500">Nudist Waifu</span> who loves to share your Goddess body? Step Into the <span className="text-cyan-400">Spotlight</span>, <span className="text-pink-500">Stunning Waifu.</span> Your Simps are <span className="text-purple-400">Patiently Waiting</span>.
        </p>
