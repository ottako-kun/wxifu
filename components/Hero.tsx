    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 animate-fade-in">
        ...
        <p className="text-lg md:text-2xl font-medium text-gray-200 tracking-wide mb-8 max-w-2xl mx-auto">
          Step Into the <span className="text-cyan-400">Spotlight</span>, <span className="text-pink-500">Stunning Waifu.</span> Your fanclub <span className="text-purple-400">Is waiting</span>.
        </p>
