          ...
          {!isVideo ? (
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                {isGif ? 'GIF or RedGIFs Link / Embed Code' : 'Image Link (Direct / RedGIFs / Drive)'}
              </label>
              <div className="relative">
                  ...
                  placeholder={isGif ? 'e.g. https://www.redgifs.com/watch/... or <iframe> embed' : "https://media.redgifs.com/ExperiencedGreedyCutworm-large.jpg"}
              ...
              <p className="text-[10px] text-gray-500 mt-2">
                  {isGif
                    ? "Paste a standard GIF link, a RedGIFs watch/embed link, or a full iframe embed code."
